        ...
        <ConditionalRender condition={useActive.isMenuOpen}>
          <div className="fixed inset-0 w-full h-screen overflow-hidden z-[1000]">
            ...
            >
              ...
              <div className={`flex items-center justify-between px-[5%] gap-4 transition-all duration-300 ease-in-out ${
                useActive.isScrolled
                  ? 'min-h-14 md:min-h-16'
                  : 'min-h-20 md:min-h-24'
              }`}>
                {/* Zoekbalk */}
                <div className="flex items-center gap-2 bg-white px-4 py-2 rounded flex-1 max-w-md">
                  <input
                    type="text"
                    placeholder="Zoeken..."
                    className="flex-1 bg-transparent text-black placeholder:text-gray-500 focus:outline-none text-sm"
                  />
              ...
              <div className="flex flex-col md:hidden h-full">
                {/* Menu items */}
                <div className="flex flex-col flex-1 mt-px">
                  <Link
                    href="/"
                    onClick={useActive.closeMenu}
                    className="heading-h3 flex items-center justify-center border-t border-white/10 px-[5%] py-4 font-bold hover:bg-white/5 transition-colors"
                  >
                    Home
                  </Link>
                  <Link
                ...
                {/* GEÏNTERESSEERD sectie onderaan */}
                <div className="px-[5%] py-6 border-t border-white/10 bg-black/20">
                  <div className="flex flex-col gap-4 text-center">
                    ...
                    <Button
                      variant="secondary"
                      size="sm"
                      className="bg-white text-black hover:bg-white/90 flex items-center justify-center gap-2 mx-auto"
                      asChild
                    >
                      <a href="https://wa.me/31857926363" className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <Button
                        variant="secondary"
                        size="sm"
                        className="bg-white text-black hover:bg-white/90 flex items-center justify-center gap-2"
                        asChild
                      >
                        <a href="https://wa.me/31857926363" className="flex items-center gap-2">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-4 h-4">
